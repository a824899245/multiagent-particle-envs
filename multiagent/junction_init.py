...
edge_list = []
e_arrival_time = [MAX for i in range(600)]
...
def inti():
    ...
    for i in range(80):
        for j in range(i):
            if (junction_position[i][0] >= 0 and junction_position[i][1] >= 0) and (
                    junction_position[j][0] >= 0 and junction_position[j][1] >= 0):
                a = pow(pow(junction_position[i][0] - junction_position[j][0], 2) + pow(
                    junction_position[i][1] - junction_position[j][1], 2), 0.5)
